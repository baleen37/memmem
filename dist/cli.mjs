...
function compressWebFetch(data) {
  ...
  const url2 = data.url || "";
  return url2 ? `Fetched ${url2}` : "Fetched";
}
...
var init_fetch = __esm({
  "node_modules/axios/lib/adapters/fetch.js"() {
    ...
    globalFetchAPI = (({ Request: Request2, Response }) => ({
      Request: Request2,
      Response
...
// node_modules/zhipuai-sdk-nodejs-v4/dist/index.js
import assert from "assert";
var import_jsonwebtoken, __defProp2, __defNormalProp, __publicField, __async, API_TOKEN_TTL_SECONDS, CACHE_TTL_SECONDS, tokenCache, generateToken, Request, BaseApi, Completions, Images, Embeddings, Files, ZhipuAI, zhipu_ai_default;
var init_dist2 = __esm({
  "node_modules/zhipuai-sdk-nodejs-v4/dist/index.js"() {
    ...
    tokenCache = {};
    generateToken = (apiSecretKey, cache = true) => {
      try {
    ...
    Request = class {
      constructor(config, authHeaders) {
        ...
        this.request = axios_default.create(config);
      ...
      post(url2, data, config) {
        return __async(this, null, function* () {
          return this.request.post(url2, data, config).then((res) => res.data);
        });
      }
      postForm(url2, data, config) {
        return __async(this, null, function* () {
          return this.request.post(url2, data, config).then((res) => res.data);
        });
      }
      get(url2, config) {
        return __async(this, null, function* () {
          return this.request.get(url2, config).then((res) => res.data);
        });
      }
      put(url2, data, config) {
        return __async(this, null, function* () {
          return this.request.put(url2, data, config).then((res) => res.data);
        });
      }
      delete(url2, config) {
        return __async(this, null, function* () {
          return this.request.delete(url2, config).then((res) => res.data);
        });
      }
    };
    BaseApi = class {
    ...
    Completions = class extends BaseApi {
      create(options) {
        return __async(this, null, function* () {
    ...
    Embeddings = class extends BaseApi {
      create(options) {
        return __async(this, null, function* () {
  ...
  "src/core/llm/zhipu-provider.ts"() {
    ...
    ZhipuAIProvider = class {
      ...
      constructor(apiKey, model = DEFAULT_MODEL2) {
        ...
        this.client = new zhipu_ai_default({
          apiKey,
          cacheToken: true
        });
        this.model = model;
